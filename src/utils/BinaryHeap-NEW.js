 ...
 * BinaryHeap-NEW.js
 * 
 * CUSTOM WRAPPER - Wraps the original BinaryHeap to make it available as an ES6 module
 * This is needed because Potree_update_visibility.js and ProfileRequest.js use BinaryHeap
 * but it was not included in the original bundle
 */
...
// Export the BinaryHeap class
export {BinaryHeap};

// CUSTOM ADDITION - Also make it available globally for legacy code
